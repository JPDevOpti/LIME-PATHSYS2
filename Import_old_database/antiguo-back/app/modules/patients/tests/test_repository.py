...
async def test_change_identification_updates_cases_patient_info(mock_db, sample_patient_dict):
    ...
    mock_db.patients.find_one.side_effect = [
        ...
        {**sample_patient_dict, "patient_code": "CC-87654321"},  # fetch updated
    ]
    ...
    assert args[0] == {"patient_info.patient_code": "CC-12345678"}
    assert args[1] == {"$set": {"patient_info.patient_code": "CC-87654321"}}

    # Verifica el retorno del paciente con nuevo código
    assert updated["patient_code"] == "CC-87654321"