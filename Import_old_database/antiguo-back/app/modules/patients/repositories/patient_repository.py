...
class PatientRepository:
    ...
    async def create(self, patient: PatientCreate) -> dict:
        try:
            normalized_identification_number = normalize_identification_number(patient.identification_number)
            patient.identification_number = normalized_identification_number
            patient.patient_code = build_patient_code(patient.identification_type, normalized_identification_number)
    ...
    async def change_identification(self, old_code: str, new_identification_type: str, new_identification_number: str, cases_collection) -> dict:
        ...
        normalized_type = normalize_identification_type_value(new_identification_type)
        normalized_number = normalize_identification_number(new_identification_number)
        new_code = build_patient_code(normalized_type, normalized_number)
        ...
        await self.collection.update_one(
            old_query,
            {"$set": {
                "identification_type": normalized_type,
                "identification_number": normalized_number,
