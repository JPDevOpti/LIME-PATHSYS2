...
class PatientService:
    ...
    async def change_patient_identification(self, patient_code: str, new_identification_type: IdentificationType | int | str, new_identification_number: str) -> PatientResponse:
        ...
        try:
            new_type_value = normalize_identification_type_value(new_identification_type)
            new_number_value = normalize_identification_number(new_identification_number)
            new_code = build_patient_code(new_type_value, new_number_value)
        ...
        patient_data = await self.repository.change_identification(patient_code, new_type_value, new_number_value, cases_collection)
        if not patient_data:
