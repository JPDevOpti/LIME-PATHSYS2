...
class FakeService:
    async def create_case(self, payload: CaseCreate) -> CaseResponse:
        return CaseResponse(
            ...
            patient_info=payload.patient_info.model_copy(update={"patient_code": "CC-12345678"}),
    ...
    async def update_case(self, code: str, payload: CaseUpdate) -> CaseResponse:
        ...
        return CaseResponse(
            id="656565656565656565656565",
            case_code=code,
            patient_info=_payload().patient_info.model_copy(update={"patient_code": "CC-12345678"}),
            requesting_physician="Dr. Demo",
            service="Consulta externa",
            samples=[],
...
def test_route_create_case_success():
    ...
    assert body["patient_info"]["patient_code"] == "CC-12345678"
