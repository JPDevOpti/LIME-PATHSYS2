...
interface BillingTestsChartProps {
    datos: BillingTestItem[];
}

export function BillingTestsChart({ datos }: BillingTestsChartProps) {
    ...
    return (
        <BaseCard className="p-6">
            <div className="flex items-center gap-2 mb-4">
                ...
                <div>
                    <h3 className="text-lg font-semibold text-neutral-900">Facturación por prueba</h3>
                    <p className="text-sm text-neutral-500">
                        Monto generado por cada tipo de prueba.
                    </p>
                </div>
            </div>
