...
import { PathologistsPerformancePanel } from '../pathologist/PathologistsPerformancePanel';
import { TestsOpportunityPanel } from '../test/TestsOpportunityPanel';
...
export function OpportunityReport() {
    ...
    const opportunityStats = useMemo((): EstadisticasOportunidad | null => {
        ...
        return {
            ...
            total_casos_periodo: s.total,
            casos_sin_evaluacion_oportunidad: Math.max(0, s.total - s.within - s.out),
