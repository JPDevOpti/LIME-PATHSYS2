...
import { OutOfOpportunityCasesModal } from '@/features/dashboard/ui/OutOfOpportunityCasesModal';
        ...
        const loadOutCases = async () => {
            try {
                ...
                const filteredCases = response.data.filter((caseItem) => {
                    ...
                    if (!selectedEntity) return !isCaseFromHama(caseItem);
                    return true;
                });
